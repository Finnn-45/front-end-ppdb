...
const PageFormPrestasi: React.FC = () => {
  ...
  const textAreaClass =
    "w-full border border-gray-300 rounded-xl px-4 py-3 text-sm sm:text-base focus:ring-2 focus:ring-[#1E3A8A] focus:outline-none transition duration-200 resize-none leading-relaxed";
    ...
    <>
      ...
      <header className="relative h-64 md:h-72 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          <p className="mt-3 text-[#949494] text-base sm:text-lg md:text-xl font-medium opacity-95">
            Data Prestasi
          </p>
        </div>
      </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <section className="bg-white rounded-xl shadow-sm border overflow-hidden">
            ...
            <div className="p-4 sm:p-6 grid grid-cols-1 gap-4">
              <textarea
                name="achievement"
                placeholder="Riwayat Prestasi  (Kompetisi, juara, Tingkatan) jika ada"
              ...
              <textarea
                name="organization"
                placeholder="Riwayat Organisasi (Divisi, Jabatan)"
